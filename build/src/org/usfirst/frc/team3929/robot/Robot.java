...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		readEncoders();
		SmartDashboard.putString("DB/String 0", "Current DriveMode");
		SmartDashboard.putString("DB/String 5", currentDriveMode.name());
		
		SmartDashboard.putString("DB/String 1", "Forward Distance");
		SmartDashboard.putString("DB/String 6", Double.toString(forwardDistance));
		
		SmartDashboard.putString("DB/String 2", "Strafe Distance");
		SmartDashboard.putString("DB/String 7", Double.toString(strafeDistance));

		SmartDashboard.putString("DB/String 3", "Gyro Angle");
		SmartDashboard.putString("DB/String 8", Double.toString(imu.getYaw()));
		
		SmartDashboard.putString("DB/String 4", "One Tote Limit");
		SmartDashboard.putBoolean("DB/String 9", !oneToteLimit.get() );
